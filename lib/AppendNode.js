 ...
 */
export default function AppendNode(canvas, eventBus, overlays, appendPreview) {
  this._canvas = canvas;
...
AppendNode.prototype.getActions = function(target) {
  ...
  forEach(providers, (provider) => {
    ...
    entries.hover = (_, element) => {
      ...
      this._appendPreview.create(element, 'bpmn:Task', { hidden: true });
...
AppendNode.prototype.getNode = function(target) {
  ...
  */
  ...
  domDelegate.bind(html, nodeSelector, 'mouseover', function(event) {
    self.trigger('mouseover', event);
  });

  domDelegate.bind(html, nodeSelector, 'mouseout', function(event) {
