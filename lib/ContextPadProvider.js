      ...
      'replace': {
        ...
        html: `<div class="entry">
          <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="10" height="10" rx="5" fill="white" stroke="#161616"/>
            <rect x="5.5" y="5.5" width="11" height="9" rx="2.5" fill="white" stroke="#161616"/>
          </svg>
        </div>`,
      ...
      'delete': {
        ...
        html: `<div class="entry">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M7 6H6V12H7V6Z" fill="#161616"/>
            <path d="M10 6H9V12H10V6Z" fill="#161616"/>
            <path d="M2 3V4H3V14C3 14.2652 3.10536 14.5196 3.29289 14.7071C3.48043 14.8946 3.73478 15 4 15H12C12.2652 15 12.5196 14.8946 12.7071 14.7071C12.8946 14.5196 13 14.2652 13 14V4H14V3H2ZM4 14V4H12V14H4Z" fill="#161616"/>
            <path d="M10 1H6V2H10V1Z" fill="#161616"/>
          </svg>
        </div>`,
