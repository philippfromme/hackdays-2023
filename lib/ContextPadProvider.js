      ...
      'replace': {
        ...
        html: `<div class="entry">
          <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <mask id="myMask">
              <rect x="0" y="0" width="17" height="15" fill="white" stroke="white" />
              <rect x="5.5" y="5.5" width="11" height="9" rx="2.5" fill="black" stroke="black" />
            </mask>
            <rect x="0.5" y="0.5" width="10" height="10" rx="5" fill="transparent" stroke="currentColor" mask="url(#myMask)" />
            <rect x="5.5" y="5.5" width="11" height="9" rx="2.5" fill="transparent" stroke="currentColor" />
          </svg>
        </div>`,
